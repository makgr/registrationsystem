    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Approved Registration</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <h5 class="card-title">All Approved Registration</h5>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered tbl">
                                ...
                                <tbody>
                                    <?php
                                    $getStaff = $admin->getApprovedRegistrationList();
                                    if ($getStaff) {
                                        $i = 0;
                                        while ($result = $getStaff->fetch_assoc()) {
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                               <a href="view-approved-registration.php?aid=<?php echo $result['id']; ?>"><span class="label label-primary">View</span></a>
                                               </td>
