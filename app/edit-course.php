                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" pattern="^[0-9]" title='Only Number' min="1" max="4" step="any" class="form-control" id="course_credit" name="course_credit" value="<?php echo $res['course_credit']; ?>" placeholder="Course credit" autocomplete="off" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
